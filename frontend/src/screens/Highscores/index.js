                  ...
                  <div id="panel-1" className="panel">
                    <div className="panel-hdr">
                      ...
                      <div className="panel-toolbar">
                        <button className="btn btn-panel waves-effect waves-themed" data-action="panel-collapse" data-toggle="tooltip" data-offset="0,10" data-original-title="Collapse"></button>
                        <button className="btn btn-panel waves-effect waves-themed" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Fullscreen"></button>
                        <button className="btn btn-panel waves-effect waves-themed" data-action="panel-close" data-toggle="tooltip" data-offset="0,10" data-original-title="Close"></button>
                      </div>
                    </div>
                  ...
                  <div id="panel-2" className="panel">
                    ...
                    <div className="panel-container show">
                      <div className="panel-content">
                        <table className="table-highscores">
                          <thead>
                            ...
                            {playerList.map((props, index) => {
                              ...
                              return (
                                <tr key={props.id}>
                                  <td>{(pageInitial) * postsPerPage + index + 1}</td>
                                  <td><img src={ outfit } alt="Outfit" /></td>
                                  <td><Link to={`/character/${props.name}`}>{props.name}</Link></td>
                                  <td>{ verify }</td>
                        ...
                        <center>
                           <button className="previous round" onClick={(e) => setPageInitial(pageInitial - 1)}>&#8249;</button>
                           {playerList.length >= 10 ? <button className="next round" onClick={() => setPageInitial(pageInitial + 1)}>&#8250;</button> : <button className="next round disabled" disabled onClick={() => setPageInitial(pageInitial + 1)}>&#8250;</button>}
                        </center>
