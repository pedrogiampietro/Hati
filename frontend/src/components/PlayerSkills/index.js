...
const PlayerSkills = props => {
	return (
		<div className="row panel-tag ">
			<div className="col-6 col-xl-3 d-sm-flex align-items-center con-tooltip top">
			...
			<div className="col-6 col-xl-3 d-sm-flex align-items-center con-tooltip bottom">
				<span className="width-6 height-2 d-inline-flex align-items-center justify-content-center position-relative h1 ">
					<img
						className="border border-primary text-primary img-thumbnail"
						src={ClubIcon}
						alt="Club"
