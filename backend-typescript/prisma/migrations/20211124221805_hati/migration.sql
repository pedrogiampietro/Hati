...
CREATE TABLE `accounts` (
    ...
    `secret` VARCHAR(191) NULL DEFAULT '',
    `type` INTEGER NULL DEFAULT 0,
    `premdays` INTEGER NULL DEFAULT 365,
    `coins` INTEGER NULL DEFAULT 0,
    `lastday` INTEGER NULL DEFAULT 0,
    `email` VARCHAR(191) NOT NULL,
    `creation` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3),
    `jwtVersion` INTEGER NULL DEFAULT 0,
    `vote` INTEGER NULL DEFAULT 0,
    `key` VARCHAR(191) NULL DEFAULT '',
    `email_new` VARCHAR(191) NULL DEFAULT '',
    `email_new_time` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3),
    `rlname` VARCHAR(191) NULL DEFAULT '',
    `location` VARCHAR(191) NULL DEFAULT '',
    `page_access` INTEGER NULL DEFAULT 0,
    `email_code` VARCHAR(191) NULL DEFAULT '',
    `next_email` INTEGER NULL DEFAULT 0,
    `premium_points` INTEGER NULL DEFAULT 0,
    `secret_status` BOOLEAN NULL DEFAULT false,
    `create_date` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3),
    `create_ip` VARCHAR(191) NOT NULL,
    `last_post` INTEGER NULL DEFAULT 0,
    `flag` VARCHAR(191) NULL DEFAULT '',
    `vip_time` INTEGER NULL DEFAULT 0,
    `guild_points` INTEGER NULL DEFAULT 0,
    `guild_points_stats` INTEGER NULL DEFAULT 0,
    `passed` INTEGER NULL DEFAULT 0,
    `block` INTEGER NULL DEFAULT 0,
    `refresh` INTEGER NULL DEFAULT 0,
    `birth_date` VARCHAR(191) NULL DEFAULT '',
    `gender` VARCHAR(191) NULL DEFAULT '',
    `profileName` VARCHAR(191) NULL DEFAULT '',
    `passwordResetExpires` DATETIME(3) NULL,
    `passwordResetToken` VARCHAR(191) NULL,
    `avatar` VARCHAR(191) NULL DEFAULT '',
    `loyalty_points` INTEGER NULL DEFAULT 0,
    `authToken` VARCHAR(191) NULL DEFAULT '',
    `player_sell_bank` INTEGER NULL DEFAULT 0,
    `tournamentBalance` INTEGER NULL DEFAULT 0,
